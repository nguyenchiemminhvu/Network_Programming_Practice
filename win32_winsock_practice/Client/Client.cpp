...
int main()
{
    ...
    std::thread udp_client(ClientServer_EventSelectModel::UDP_Client, std::ref(p_server_ip));
    ...
    std::thread tcp_client(ClientServer_EventSelectModel::TCP_Client, s_server_ip);
