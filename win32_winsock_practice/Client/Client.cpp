...
int main()
{
    ...
    std::thread udp_client(ClientServerApplication_Async::UDP_Client, std::ref(p_server_ip));
    ...
    std::thread tcp_client(ClientServerApplication_Async::TCP_Client, s_server_ip);
